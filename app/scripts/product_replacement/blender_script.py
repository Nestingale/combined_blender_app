...
def perform_replace(from_name, to_glb, new_name, original_object, original_mesh, original_location, original_rotation, original_mesh_world_pos, original_floor_z):
    ...
    if main_imported_obj.type == 'EMPTY':
        ...
        main_imported_obj.location = (0, 0, 0)  # Start at parent's origin
        
        # Don't modify the rotation of mesh children - keep GLB's native orientation
        ...
        # GLB is just a mesh - parent it directly
        # Don't modify the mesh rotation - keep GLB's native orientation
        main_imported_obj.parent = empty_obj
        main_imported_obj.location = (0, 0, 0)  # Start at parent's origin
